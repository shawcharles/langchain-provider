...
# Griffin imports
from griffin.plugins.completion.api import CompletionRequestTypes, CompletionItemKind
        ...
        if msg_type == CompletionRequestTypes.DOCUMENT_DID_OPEN:
            ...
            if completions is not None:
                for i, completion in enumerate(completions):
                    ...
                    griffin_completions.append(entry)
            self.sig_response_ready.emit(_id, {"params": griffin_completions})
